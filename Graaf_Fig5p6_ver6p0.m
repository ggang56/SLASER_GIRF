...
data_filename = 'Graaf_Fig5p6_ver6p0';
...
plot(Delta_Hz*1e-3, real(mxy_sinc_excitation), 'r', 'LineWidth', LineWidth);
plot(Delta_Hz*1e-3, imag(mxy_sinc_excitation), 'b', 'LineWidth', LineWidth);
...
plot(Delta_Hz*1e-3, real(mxy_gaussian_excitation_beta1), 'r', 'LineWidth', LineWidth);
plot(Delta_Hz*1e-3, imag(mxy_gaussian_excitation_beta1), 'b', 'LineWidth', LineWidth);
